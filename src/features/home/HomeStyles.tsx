...
export const useHomePageContainerStyles = () => {
    ...
    const HomePageStyles = {
        ...
        minHeight: isSmallScreen ? '4300px': (isMediumScreen ? '4390px': '2200px'), 
        minWidth: isSmallScreen ? '250px' : (isMediumScreen ? '600px' : '900px'), 
        width: '100%',
    };
...
export const useMainContainerStyles = () => {
    ...
    const MainContainerStyles = {
        ...
        minHeight: isSmallScreen ? '4240px' : (isMediumScreen ? '4350px' : '2140px')
    }
