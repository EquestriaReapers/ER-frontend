...
export const useRecoverPasswordTypographyStyles = () => {
    ...
    const RecoverPasswordTypographyStyles = {
        fontSize:  isExtraSmallScreen ? XS_SCREEN_LARGE_FONT_SIZE : LG_SCREEN_LARGE_FONT_SIZE, 
...
export const useForgotEmailStyles = () => {
    ...
    const ForgotEmailStyles  = {
        display:'grid', 
        fontSize: isExtraSmallScreen? XS_SCREEN_SMALL_FONT_SIZE: LG_SCREEN_SMALL_FONT_SIZE, 
        color: '#007BFF'
    }
